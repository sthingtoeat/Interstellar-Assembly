package com.qly.mallchat.common.common.config;

import com.qly.mallchat.common.common.thread.MyThreadFactory;
...
public class ThreadPoolConfig implements AsyncConfigurer {
    ...
    public ThreadPoolTaskExecutor websocketExecutor() {
        ...
        executor.setRejectedExecutionHandler(new ThreadPoolExecutor.DiscardPolicy());//这里推不过去就算了，直接丢了
        executor.setThreadFactory(new MyThreadFactory(executor));
        executor.initialize();
        return executor;
    }
